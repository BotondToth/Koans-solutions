...
class GroceryList extends React.Component {
  ...
  addGroceryItem() {
    if(this.state.newGroceryName) {
      ...
      this.setState({
        groceries: this.state.groceries.concat([newGroceryItem]), completed: false
      });
    }
  }
  ...
  toggleGroceryCompleteness(groceryIndex) {
    var newState = React.addons.update(this.state, { groceries: {[groceryIndex]: {completed: {$set: true}}}});
